...
function handleSongChangeEvent(event) {
    ...
    const httpQuery = "http://localhost:3001/listDistinctArtistsTest?title=" + songTitle;
...
function handleArtistChangeEvent(event) {
    ...
    const xhr = new XMLHttpRequest();
    const httpQuery = "http://localhost:3001/listDistinctTitlesTest?artist=" + artist;
    xhr.open('GET', httpQuery); // Replace with your API endpoint
...
function retrieveAndDisplaySong(){
    ...
    const xhr = new XMLHttpRequest();
    const httpQuery = "http://localhost:3001/getLyricsTest?artist=" + songArtist + "&title=" + songTitle;
    xhr.open('GET', httpQuery); // Replace with your API endpoint
...
function initSongSelection() {
    ...
    const xhr = new XMLHttpRequest();
    xhr.open('GET', 'http://localhost:3001/listTitlesTest'); // Replace with your API endpoint
...
function initArtistSelection() {
    ...
    const xhr = new XMLHttpRequest();
    xhr.open('GET', 'http://localhost:3001/listArtistsTest'); // Replace with your API endpoint
